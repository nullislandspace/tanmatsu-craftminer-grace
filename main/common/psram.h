#pragma once
// =====================================================================
//  CraftMiner  --  the one host/badge seam
// ---------------------------------------------------------------------
...
//  on the badge in minutes (claudeplans/craftminer.md, Part H).
//
...
#include <stdlib.h>
#define cm_alloc(n)      malloc(n)
#define cm_calloc(n, s)  calloc((n), (s))
#define cm_realloc(p, n) realloc((p), (n))
#define cm_free(p)       free(p)

#else

#include "esp_heap_caps.h"
#define cm_alloc(n)      heap_caps_malloc((n), MALLOC_CAP_SPIRAM)
#define cm_calloc(n, s)  heap_caps_calloc((n), (s), MALLOC_CAP_SPIRAM)
#define cm_realloc(p, n) heap_caps_realloc((p), (n), MALLOC_CAP_SPIRAM)
#define cm_free(p)       heap_caps_free(p)
